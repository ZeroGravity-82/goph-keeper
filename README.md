...
| Исходный файл бинарной записи до шифрования | 100 МБ                                                        | клиент |
| Зашифрованный файл бинарной записи | 200 МБ                                                        | сервер |
...
Сейчас используется single-part upload зашифрованного файла. Максимальный размер исходного файла для одной приватной записи ограничен 100 МБ. Ограничение применяется к файлу до шифрования и передачи на сервер. На стороне сервера дополнительно используется лимит 200 МБ для уже зашифрованного файла, чтобы оставить запас на служебные данные шифрования.
