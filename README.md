...
| Поле `text` текстовой записи | 256 кБ                                                        | клиент |
...
| Зашифрованный payload приватной записи | 1024 кБ                                                       | сервер |
| Исходный файл бинарной записи до шифрования | 1024 МБ                                                       | клиент |
| Зашифрованный файл бинарной записи | 1025 МБ                                                       | сервер |
| Стандартная часть multipart-загрузки зашифрованного файла | не меньше 5 МБ, если зашифрованный файл больше 5 МБ            | сервер |
...
- лимит исходного файла 1024 МБ является продуктовым ограничением, а не техническим пределом потокового шифрования или
