...
- клиентский сценарий обновления файла приватной записи типа `binary`;
- хранение токенов между запусками CLI-клиента.
...
- добавить в CLI-клиент автоматическое обновление access-токена через refresh-токен при истечении TTL.
