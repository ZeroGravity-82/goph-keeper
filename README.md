...
- переход от текущего интерактивного CLI на TUI: текущий CLI-режим достаточен для MVP, но ручная обработка терминального ввода остается хрупкой и может быть заменена полноценным терминальным интерфейсом после стабилизации основных сценариев;
